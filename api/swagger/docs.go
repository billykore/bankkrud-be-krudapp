...
const docTemplate = `{
        ...
        "/schedules": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit number of schedules to return",
                        "name": "limit",
                        "in": "query"
                    },
                    {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "name": "UpdateScheduleStatusRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schedule.UpdateScheduleStatusRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "schedule.UpdateScheduleStatusRequest": {
            "type": "object",
            "required": [
                "status",
                "uuid"
